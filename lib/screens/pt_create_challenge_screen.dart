      ...
      try {
        ...
        if (mounted) {
          ...
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(const SnackBar(content: Text('Tạo thử thách thành công!'), backgroundColor: Colors.green));
          ...
          : Form(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  if (_difficulty == "Bình thường") ...[
                    Text(
                      "Thời hạn: ${_hours.toStringAsFixed(1)} giờ",
                    ...
                    onPressed: () {
                      if (_difficulty == "Rất khó" && _customEndTime == null) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('Vui lòng chọn thời hạn!'), backgroundColor: Colors.red),
                        );
                        return;
                      }
                      _createChallenge();
