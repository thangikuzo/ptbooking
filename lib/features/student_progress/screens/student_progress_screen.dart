    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where('status', whereIn: const ['confirmed', 'completed'])
            .snapshots(),
        builder: (context, snapshot) {
          ...
          for (var doc in docs) {
            ...
            students[userId] = {
              ...
              'package_info': booking.packageName.isNotEmpty
                  ? "${booking.packageName} (Đã học ${booking.completedSessions}/${booking.sessionCount} buổi)"
                  : "Đã đăng ký ${booking.sessionCount} buổi",
            };
          }
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return _buildStudentCard(
                ...
                packageInfo: student['package_info'],
              );
            },
          );
        },
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(packageInfo, style: const TextStyle(color: Colors.grey, fontSize: 13)),
              ],
            ),
          ),
          ElevatedButton(
