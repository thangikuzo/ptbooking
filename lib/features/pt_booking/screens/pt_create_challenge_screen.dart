      ...
      try {
        ...
        if (mounted) {
          ...
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(SnackBar(content: Text('Tạo thử thách thành công!'), backgroundColor: Colors.green));
                    ...
                    onPressed: () {
                      if (_difficulty == "Rất khó" && _customEndTime == null) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Vui lòng chọn thời hạn!'), backgroundColor: Colors.red),
                        );
                        return;
                      }
                      _createChallenge();
