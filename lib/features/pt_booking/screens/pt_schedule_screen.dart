  ...
  Future<void> _saveSchedule() async {
    ...
    if (user == null) {
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text("Lỗi: Chưa đăng nhập!"), backgroundColor: Colors.red));
      }
      return;
    }
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text("Đã lưu lịch làm việc!"), backgroundColor: Colors.green));
      }
    } catch (e) {
